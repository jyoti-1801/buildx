               ...
               <div class="col-lg-8 col-md-7 col-sm-12 col-12">
                           ...
                           <div class=" col-12">
                              <div class="card rounded-0 bg-white brand-shadow mb-2">
                                 <div class="card-header doc-header">
                                    <h5 class="mb-0 fw-500 text-white text-center">Videos</h5>
                                 </div>
                                                   ...
                                                   <div class="modal-dialog modal-lg">
                                                      <div class="modal-content rounded-0 border-0">
                                                         ...
                                                         <div class="modal-body">
                                                            <form class="modal-from" method="POST" action="{{route('video.folder.store')}}">
                                                               @csrf
                                             ...
                                             <div class="row">
                                                <div class="table-responsive">
                                                   <table
                                                      ...
                                                      data-bs-target="#exampleModal2" data-id="{{ $d->video_id }}"><span
                                                                                 class="me-3"><img
                                                                           ...
                                                                           <div
                                                                              class="d-flex justify-content-start align-items-center px-2">
                                                                              <a href="{{route('videos.delete',['video_id' => $d->id]) }}"
                                                                                 class="text-center"><span
                                                                                 class="me-3"><img
                    ...
                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                        <div class="row">
                            ...
                            <div class=" col-12">
                                <div class="card rounded-0 bg-white brand-shadow mb-2">
                                  <div class="card-header doc-header">
                                    <h4 class="mb-0 fw-500 text-white text-center">Videos</h4>
                                  </div>
                                   <div class="card-body px-4">
                                    <div class="row">
                                        <h5 class="fw-600">Main</h5>
                                                          ...
                                                          <div class="py-5">
                                      <div class="d-flex flex-column">
                                          <div class="text-center"><img src="../assets/img/VideoCall.png" class="img-fluid" width="57" height="57"/></div>
                                          <div class="text-center mb-2"><h5 class="fw-600">No Folders</h5></div>
                                          <div class="text-center mb-4"><p class="mb-0 fw-300">This folder is empty, add a folder by clicking "Add a Folder" button.</p></div>
                                          <div class="row">
                                             <div class="col-lg-5 col-md-10 col-sm-8 col-12 mx-auto">
                                                <div class="d-flex justify-content-between align-items-center flex-wrap">
                                                    <div>
                                                      <button type="button" class="btn btn-folder" data-bs-toggle="modal" data-bs-target="#exampleModal">New Folder</button>
                                                      <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                          <div class="modal-dialog modal-lg">
                                                              <div class="modal-content rounded-0 border-0">
                                                                  <div class="modal-custom-header doc-header py-2 px-2">
                                                                      <h6 class="mb-0 fw-400 text-white ">Folder
                                                                          info</h6>
                                                                  </div>
                                                                  <div class="modal-body">
                ...
                <select class="form-select"  aria-label="Default select example" name="parent">
                   ...
                   <option value="Engineer">Engineer</option>
                                                    ...
                                                    <div>
                                                      <button type="button" class="btn folder-import1" data-bs-toggle="modal" data-bs-target="#exampleModal1">Import Folder</button>
                                                                      ...
                                                                      <div class="modal-body">
                                                                          <form class="modal-from">
                                                                              <div class="d-flex justify-content-start align-items-center mb-4">
                                                                                  <button type="submit" class="btn btn-save shadow-sm">Import</button>
                                                                              </div>
                                                                              <div class="mb-3">
                                                                                  <h6 class="fw-700">Import Options
                                                                                  </h6>
                                                                              ...
                                                                              <div class="mb-3">
                                                                                  <label class="form-label modal-label position-relative">Source
                                                                                      Template
                                                                                  </label>
                                                                              ...
                                                                              <div class="mb-3 form-check">
                                                                                  <input type="checkbox" class="form-check-input rounded-sm" id="Schedule">
                                                                                  <label class="form-check-label" for="Schedule">
                                                                                      Schedule
                                                                                  </label>
                                                                              </div>
                                                                              <div class="mb-3 form-check">
                                                                                  <input type="checkbox" class="form-check-input rounded-sm" id="todo">
                                                                                  <label class="form-check-label" for="todo">To-Do's</label>
                                                                              </div>
                                                                              <div class="mb-3 form-check">
                                                                                  <input type="checkbox" class="form-check-input rounded-sm" id="selcetion">
                                                                                  <label class="form-check-label" for="selcetion">Selcetion</label>
                                                                              </div>
                                                                              <div class="mb-0">
                                                                                  <p class="fw-400 mb-3">Files</p>
                                                                              </div>
                                                                              <div class="mb-3 form-check">
                                                                                  <input type="checkbox" class="form-check-input rounded-sm" id="Owner">
                                                                                  <label class="form-check-label" for="Owner">Document
                                                                                      Folders</label>
                                                                              </div>
                                                                              <div class="mb-3 form-check">
                                                                                  <input type="checkbox" class="form-check-input rounded-sm" id="Owner">
                                                                                  <label class="form-check-label" for="Owner"> Photo
                                                                                      Folders</label>
                                                                              </div>
                                                                              <div class="mb-3 form-check">
                                                                                  <input type="checkbox" class="form-check-input rounded-sm" id="Owner">
                                                                                  <label class="form-check-label" for="Owner"> Video
                                                                                      Folders</label>
                                                                              </div>
                                                                              <div class="mb-0">
                                                                                  <p class="fw-400 mb-3">Messaging</p>
                                                                              ...
                                                                              <div class="mb-3 form-check">
                                                                                  <input type="checkbox" class="form-check-input rounded-sm" id="Owner">
                                                                                  <label class="form-check-label" for="Owner">Surveys</label>
                                                                              </div>
                                                                              <div class="mb-0">
                                                                                  <p class="fw-400 mb-3">Financial</p>
                                                                              </div>
                                                                              ...
                                                                              <div class="mb-3 form-check">
                                                                                  <input type="checkbox" class="form-check-input rounded-sm" id="Owner">
                                                                                  <label class="form-check-label" for="Owner">Estimates</label>
                                                                              </div>
                                                                          </form>
                                                                      </div>
                                                                  </div>
